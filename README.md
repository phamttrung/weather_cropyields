...
•	Crop yield data (date range: January 1, 1887 - December 31, 2025) https://data.ontario.ca/dataset/ontario-field-crops-production-estimate-by-crop

•	Historical weather data from http://climate.weather.gc.ca/climate_data/bulk_data_e.html
(daily data at WOODSTOCK station for years from 1887 and STRATHROY-MULLIFARRY to fill data gap of WOODSTOCK station) 
